...
<html lang="en">
    ...
    <head>
        ...
        <link href="resources/portfolio/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
        <link href='https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800' rel='stylesheet' type='text/css'>
        <link href='https://fonts.googleapis.com/css?family=Merriweather:400,300,300italic,400italic,700,700italic,900,900italic' rel='stylesheet' type='text/css'>

        <!-- Plugin CSS -->
        <link href="resources/portfolio/vendor/magnific-popup/magnific-popup.css" rel="stylesheet">

        <!-- Custom styles for this template -->
        <link href="resources/portfolio/css/creative.min.css" rel="stylesheet">
            ...
            <div class="container my-auto">
                <div class="row">
                    ...
                    <div class="col-lg-8 mx-auto">
                        ...
                        <a class="btn btn-primary btn-xl js-scroll-trigger" href="#portfolio">Projetos</a>
                    </div>
                </div>
            </div>
        </header>
        ...
        <section class="p-0" id="portfolio">
            <div class="container-fluid p-0">
				...
				<div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="resources/portfolio/img/portfolio/fullsize/13.jpg">
                            <img class="img-fluid" src="resources/portfolio/img/portfolio/thumbnails/13.jpg" alt="">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="resources/portfolio/img/portfolio/fullsize/5.jpg">
                            <img class="img-fluid" src="resources/portfolio/img/portfolio/fullsize/5.jpg" alt="">
                            <div class="portfolio-box-caption">
                                <div class="portfolio-box-caption-content">
                                    <div class="project-category text-faded">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="service-box mt-5 mx-auto">
                            ...
                            <h3 class="mb-4">Analista Desenvolvedor PL II Java/Spring/Angular/TS</h3>
                       ...
                       <div class="col-lg-3 col-md-6 text-center">
                        <div class="service-box mt-5 mx-auto">
                            <i class="fas fa-4x fa-gem text-primary mb-3 sr-icon-1"></i>
                            <h3 class="mb-4">Analista Desenvolvedor JR III C#/.NET/AngularJS</h3>
